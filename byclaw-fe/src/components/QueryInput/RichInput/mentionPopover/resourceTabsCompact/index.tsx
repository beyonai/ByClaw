...
const ResourceTabsCompact: React.FC<Props> = ({
  open,
  onSelect,
  keyword,
  header,
  ...
  const { agentInfo, EventEmitter } = useGlobal();
    ...
    <div className={classNames(styles.wrap, { [styles.noBorder]: hideBorder })}>
      ...
      <div className={styles.searchRow}>
        ...
        {activeTab === 'skill' && (
          ...
          >
            <Button size="small" icon={<UploadOutlined />} loading={skillUploading} disabled={skillUploading}>
...
export default ResourceTabsCompact;
