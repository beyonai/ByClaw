...
const LateEmployees = (props: IProps, ref: any) => {
      ...
      {!isLoading && (
        ...
        >
          <InfiniteScroll
            ...
            scrollableTarget="lateEmployeeListWrap"
            inverse={false}
...
export default forwardRef(LateEmployees);
