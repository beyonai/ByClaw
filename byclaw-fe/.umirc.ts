...
export default defineConfig({
  ...
  metas: [
    ...
    { name: 'keywords', content: '鲸智百应, 下载, APP, 智能助手, 办公助手, AI应用, 微信扫码, 超级助手' },
    {
      name: 'description',
      content:
        '鲸智百应是一款企业级AI操作系统，致力于为企业中的每一位员工量身打造“一呼百应” 的超级助手，助力员工摆脱繁琐事务的羁绊，使其得以全身心聚焦于分析、改进、决策等价值创造工作，进而突破个体工作效率的既有上限；具备自然语言交互、低侵入集成、自我进化以及安全可靠等特性，面向垂直领域与专业岗位提供低成本的高效赋能，切实满足不同业务场景下的多样化需求。鲸智百应精心构建的 “1 + 1 + N” 新型智能协作网络，全面覆盖了人、AI能力、数据、知识以及功能等生产要素，不仅重新定义了组织的工作方式，也塑造了 “生产提效、管理可控、持续成长” 的生产力优化闭环，助推企业的高效运营与持续发展。',
    },
