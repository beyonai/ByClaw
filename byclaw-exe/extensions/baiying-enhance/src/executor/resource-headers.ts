...
/** Mirror of `_build_resource_mcp_headers`. */
export function buildResourceMcpHeaders(capability: Capability): {
...
export function debugMcpSessionHeaders(params: {
  ...
  resourceHeaders: Record<string, string> | undefined;
  ...
  try {
    console.log(
      JSON.stringify({
        ...
        resource_x_session_id: pickInsensitive(params.resourceHeaders, "X-Session-Id"),
