 ...
 */
@Service
public class AiWriterAgentHandler extends CommonHandler implements InitializingBean {
    ...
    public void afterPropertiesSet() throws Exception {
        AgentTypeHandlerFactory.register(AgentTypeEnum.WRITER.getNameCode(), this);
        AgentTypeHandlerFactory.register(AgentTypeEnum.WRITER.getName(), this);
    }
}
