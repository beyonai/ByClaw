 ...
 */
public class FeiLianAuthenticationFilter extends AbstractAuthenticationProcessingFilter {

    private static final Logger logger = LoggerFactory.getLogger(FeiLianAuthenticationFilter.class);

    public FeiLianAuthenticationFilter(RequestMatcher pathRequestMatcher,
    ...
    public Authentication attemptAuthentication(HttpServletRequest request, HttpServletResponse response)
        ...
        logger.info("飞连陆验证码:{}", code);

        // 封装成Spring Security需要的对象
        FeiLianAuthentication authentication = new FeiLianAuthentication();
