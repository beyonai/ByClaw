...
public class DingtalkAuthenticationFilter extends AbstractAuthenticationProcessingFilter {
    ...
    private static final Logger logger = LoggerFactory.getLogger(DingtalkAuthenticationFilter.class);

    public DingtalkAuthenticationFilter(RequestMatcher pathRequestMatcher,
    ...
    public Authentication attemptAuthentication(HttpServletRequest request, HttpServletResponse response)
        ...
        logger.info("钉钉authCode码:{},登录类型是:{}", code, loginType);

        // 封装成Spring Security需要的对象
        DingtalkAuthentication authentication = new DingtalkAuthentication();
