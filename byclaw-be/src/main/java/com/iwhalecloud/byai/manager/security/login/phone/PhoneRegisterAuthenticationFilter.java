 ...
 */
public class PhoneRegisterAuthenticationFilter extends AbstractAuthenticationProcessingFilter {

    private static final Logger logger = LoggerFactory.getLogger(PhoneRegisterAuthenticationFilter.class);

    public PhoneRegisterAuthenticationFilter(RequestMatcher pathRequestMatcher,
    ...
    public Authentication attemptAuthentication(HttpServletRequest request, HttpServletResponse response)
        ...
        PhoneRegisterAuthentication authentication = new PhoneRegisterAuthentication();
