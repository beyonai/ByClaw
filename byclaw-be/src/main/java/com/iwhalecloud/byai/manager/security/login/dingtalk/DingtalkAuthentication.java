...
@Getter
@Setter
public class DingtalkAuthentication extends AbstractAuthenticationToken {
    ...
    public Object getPrincipal() {
        return isAuthenticated() ? users : code;
    }
    ...
    public Object getCredentials() {
        return isAuthenticated() ? null : loginType;
    }
