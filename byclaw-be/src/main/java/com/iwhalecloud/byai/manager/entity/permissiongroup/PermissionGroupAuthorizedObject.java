...
/**
 * 权限组授权对象关联实体类
 * 对应数据库表：permission_group_authorized_objects
 */
@Getter
@Setter
@TableName("permission_group_authorized_objects")
public class PermissionGroupAuthorizedObject {
    ...
    /**
     * 授权对象类型：user-用户, org-组织, role-角色, position-岗位
     */
