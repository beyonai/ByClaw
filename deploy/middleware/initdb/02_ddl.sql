...
CREATE TABLE byai.sandbox_service_spec (service_key character varying(128) NOT NULL, spec_json jsonb NOT NULL, template_json text, updated_at timestamp without time zone DEFAULT pg_systimestamp());
