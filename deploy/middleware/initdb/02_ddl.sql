...
CREATE UNIQUE INDEX IF NOT EXISTS uk_po_user_external_system_source_union ON byai.po_user_external_system (source_type, union_id) WHERE union_id IS NOT NULL AND btrim(union_id) <> '';
