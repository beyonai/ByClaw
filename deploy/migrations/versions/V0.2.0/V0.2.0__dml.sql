...
delete from byai.ss_resource where resource_code in('fws','wecomcli','knowledge-organizer','by-doc-to-markdown');
...
delete from byai.ss_res_ext_skill where skill_type = 'inner' and  resource_id in(20,21,22,23);
...
WHERE e.resource_id = r.resource_id
  AND r.resource_biz_type = 'SKILL'
  AND r.owner_type = 'enterprise'
  AND r.resource_code IN ('fws','wecomcli','knowledge-organizer','by-doc-to-markdown');
