...
INSERT INTO byai.ss_resource (resource_id, system_code, resource_source_pk_id, resource_biz_type, resource_type, resource_name, resource_desc, avatar, sample, tags, resource_version_id, host_type, catalog_id, man_org_id, man_user_id, index_list, create_by, create_time, update_by, update_time, com_acct_id, resource_status, resource_d_verid, resource_r_verid, resource_code, publish_time, shelf_time, unshelf_time, auth_status, publish_portal, parent_resource_id, publish_type, owner_type, impl_type, worker_agent_type) VALUES (22, 'BYAI', null, 'SKILL', 'ATOM', '文档转markdown', '通过 by‑doc‑to‑markdown 命令行工具将文档转为 Markdown 文件。适用于智能体或用户需要把本地文档转换成 Markdown 的场景：支持 PDF、doc、docx、xls、xlsx、ppt、pptx 格式文件作为输入；借助服务发现调用后端 fileToMarkdown 接口，并将转换完成后的 Markdown 内容保存至本地文件。', null, null, null, '1.0', 'hosted', 10, -1, '10001', null, 10001, '2026-06-29 08:38:43.079632', 10001, '2026-06-29 08:38:43.079632', 1, 2, -1, -1, 'by-doc-to-markdown', '2026-06-29 08:38:43.079632', null, null, 'passed', 1, -1, 'publish', 'enterprise', 'SKILL', 'NONE');
