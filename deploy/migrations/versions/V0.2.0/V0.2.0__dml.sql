...
INSERT INTO byai.ss_resource (resource_id, system_code, resource_source_pk_id, resource_biz_type, resource_type, resource_name, resource_desc, avatar, sample, tags, resource_version_id, host_type, catalog_id, man_org_id, man_user_id, index_list, create_by, create_time, update_by, update_time, com_acct_id, resource_status, resource_d_verid, resource_r_verid, resource_code, publish_time, shelf_time, unshelf_time, auth_status, publish_portal, parent_resource_id, publish_type, owner_type, impl_type, worker_agent_type)
VALUES (19, 'BYAI', null, 'SKILL', 'ATOM', 'UI技能调试器', '可视化 UI 技能测试工具，实时渲染界面、模拟用户交互，一键校验规范并做发布前检测。', null, null, null, '1.0', 'hosted', 10, -1, '10001', null, 10001, '2026-06-29 08:38:43.079632', 10001, '2026-06-29 08:38:43.079632', 1, 2, -1, -1, 'ui-skill-tester', '2026-06-29 08:38:43.079632', null, null, 'passed', 1, -1, 'publish', 'enterprise', 'SKILL', 'NONE');
...
INSERT INTO byai.ss_res_ext_skill(resource_id, skill_type, source_type, version, skill_url, skill_package_format, skill_original_filename, skill_package_size, skill_package_hash, target_content, sync_status, sync_error, last_sync_time) VALUES (18, 'inner', 'SYSTEM_BUILTIN', 'v0.1', null, 'zip', null, null, null, null, 'SUCCESS', null, CURRENT_TIMESTAMP);
INSERT INTO byai.ss_res_ext_skill(resource_id, skill_type, source_type, version, skill_url, skill_package_format, skill_original_filename, skill_package_size, skill_package_hash, target_content, sync_status, sync_error, last_sync_time) VALUES (19, 'inner', 'SYSTEM_BUILTIN', 'v0.1', null, 'zip', null, null, null, null, 'SUCCESS', null, CURRENT_TIMESTAMP);
...
WHERE e.resource_id = r.resource_id
  ...
  AND r.resource_code IN ('podcast-outline','tech-article','podcast-video','podcast-voice','podcast-script','slide-dec','unstructured-ontology-manager','structured-ontology-manager','crm-demo-showcase','github-issues-mgmt','github-code-analysis','iwhalehub','gbrain','bycli','dws','amap-visual-report-generator','ui-skill-foundry','by-knowledge-manager','ui-skill-tester');
...
delete from byai.ss_resource where resource_code in('fws','wecomcli','knowledge-organizer','by-doc-to-markdown','doc-tagger');
...
INSERT INTO byai.ss_resource (resource_id, system_code, resource_source_pk_id, resource_biz_type, resource_type, resource_name, resource_desc, avatar, sample, tags, resource_version_id, host_type, catalog_id, man_org_id, man_user_id, index_list, create_by, create_time, update_by, update_time, com_acct_id, resource_status, resource_d_verid, resource_r_verid, resource_code, publish_time, shelf_time, unshelf_time, auth_status, publish_portal, parent_resource_id, publish_type, owner_type, impl_type, worker_agent_type) VALUES (22, 'BYAI', null, 'SKILL', 'ATOM', '知识整理', '对已上传或收集的文档资料进行知识整理时使用。调度 gbrain/document-object-split/doc-tagger 三个子技能协作完成全流程：gbrain 记忆写入 → 对象类型动态拆分 → 逐文件对象打标。触发词：整理文档/帮我整理/知识整理/整理资料。', null, null, null, '1.0', 'hosted', 10, -1, '10001', null, 10001, '2026-06-29 08:38:43.079632', 10001, '2026-06-29 08:38:43.079632', 1, 2, -1, -1, 'knowledge-organizer', '2026-06-29 08:38:43.079632', null, null, 'passed', 1, -1, 'publish', 'enterprise', 'SKILL', 'NONE');
INSERT INTO byai.ss_resource (resource_id, system_code, resource_source_pk_id, resource_biz_type, resource_type, resource_name, resource_desc, avatar, sample, tags, resource_version_id, host_type, catalog_id, man_org_id, man_user_id, index_list, create_by, create_time, update_by, update_time, com_acct_id, resource_status, resource_d_verid, resource_r_verid, resource_code, publish_time, shelf_time, unshelf_time, auth_status, publish_portal, parent_resource_id, publish_type, owner_type, impl_type, worker_agent_type) VALUES (23, 'BYAI', null, 'SKILL', 'ATOM', '文档转markdown', '通过 by‑doc‑to‑markdown 命令行工具将文档转为 Markdown 文件。适用于智能体或用户需要把本地文档转换成 Markdown 的场景：支持 PDF、doc、docx、xls、xlsx、ppt、pptx 格式文件作为输入；借助服务发现调用后端 fileToMarkdown 接口，并将转换完成后的 Markdown 内容保存至本地文件。', null, null, null, '1.0', 'hosted', 10, -1, '10001', null, 10001, '2026-06-29 08:38:43.079632', 10001, '2026-06-29 08:38:43.079632', 1, 2, -1, -1, 'by-doc-to-markdown', '2026-06-29 08:38:43.079632', null, null, 'passed', 1, -1, 'publish', 'enterprise', 'SKILL', 'NONE');
INSERT INTO byai.ss_resource (resource_id, system_code, resource_source_pk_id, resource_biz_type, resource_type, resource_name, resource_desc, avatar, sample, tags, resource_version_id, host_type, catalog_id, man_org_id, man_user_id, index_list, create_by, create_time, update_by, update_time, com_acct_id, resource_status, resource_d_verid, resource_r_verid, resource_code, publish_time, shelf_time, unshelf_time, auth_status, publish_portal, parent_resource_id, publish_type, owner_type, impl_type, worker_agent_type) VALUES (24, 'BYAI', null, 'SKILL', 'ATOM', '文档打标', '当用户需要对文档打标时，根据文档内容匹配本体对象，完成结构化录入', null, null, null, '1.0', 'hosted', 10, -1, '10001', null, 10001, '2026-06-29 08:38:43.079632', 10001, '2026-06-29 08:38:43.079632', 1, 2, -1, -1, 'doc-tagger', '2026-06-29 08:38:43.079632', null, null, 'passed', 1, -1, 'publish', 'enterprise', 'SKILL', 'NONE');

delete from byai.ss_res_ext_skill where skill_type = 'inner' and  resource_id in(20,21,22,23,24);
...
INSERT INTO byai.ss_res_ext_skill (resource_id, skill_type, source_type, version, skill_url, skill_package_format, skill_original_filename, skill_package_size, skill_package_hash, target_content, sync_status, sync_error, last_sync_time) VALUES (22, 'inner', 'SYSTEM_BUILTIN', 'v0.1', null, 'zip', null, null, null, null, 'SUCCESS', null, '2026-07-10 03:29:35.235986');
INSERT INTO byai.ss_res_ext_skill (resource_id, skill_type, source_type, version, skill_url, skill_package_format, skill_original_filename, skill_package_size, skill_package_hash, target_content, sync_status, sync_error, last_sync_time) VALUES (23, 'inner', 'SYSTEM_BUILTIN', 'v0.1', null, 'zip', null, null, null, null, 'SUCCESS', null, '2026-07-10 03:29:35.235986');
INSERT INTO byai.ss_res_ext_skill (resource_id, skill_type, source_type, version, skill_url, skill_package_format, skill_original_filename, skill_package_size, skill_package_hash, target_content, sync_status, sync_error, last_sync_time) VALUES (24, 'inner', 'SYSTEM_BUILTIN', 'v0.1', null, 'zip', null, null, null, null, 'SUCCESS', null, '2026-07-10 03:06:12.037313');
...
WHERE e.resource_id = r.resource_id
  AND r.resource_biz_type = 'SKILL'
  AND r.owner_type = 'enterprise'
  AND r.resource_code IN ('fws','wecomcli','knowledge-organizer','by-doc-to-markdown','doc-tagger');
