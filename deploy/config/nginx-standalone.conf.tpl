...
server {
    ...
    location /openDesign {
        rewrite ^/openDesign(.*)$ /byaiService/openDesign$1 break;
        proxy_pass {{PROXY_HTTP}};
        ...
        proxy_set_header X-Forwarded-Port $server_port;
        proxy_set_header Cookie $http_cookie;
        proxy_cookie_path /byaiService/openDesign /openDesign;
        proxy_cookie_flags ~ samesite=lax;
    }

    location = /openDesignAdapter {
        rewrite ^ /byaiService/redirectAdapter/openDesignAdapter break;
        proxy_pass {{PROXY_HTTP}};
        ...
        proxy_set_header X-Forwarded-Port $server_port;
        proxy_set_header Cookie $http_cookie;
        proxy_cookie_path /byaiService/redirectAdapter /openDesignAdapter;
        proxy_cookie_flags ~ samesite=lax;
    }
