...
```bash
node scripts/weixin-login-gate.mjs --state-dir '<absolute-state-dir>' -- bycli weixin accounts "<account name>" --auth-source browser --site-session persistent --keep-tab true -f json
