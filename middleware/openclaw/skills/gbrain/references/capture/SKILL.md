...
- Bulk ingestion of many files → `references/media-ingest/SKILL.md` or `gbrain sync` instead
- Article/link with author + publication metadata → `references/idea-ingest/SKILL.md` (it knows to build the people page)
- Meeting transcripts → `references/meeting-ingestion/SKILL.md` (attendee enrichment)
