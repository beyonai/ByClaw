...
# walk them per references/migrations/v0.11.0.md + docs/guides/plugin-handlers.md,
...
Check for common misfiling patterns (see `references/_brain-filing-rules.md`):
