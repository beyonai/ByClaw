...
> **Convention:** See `references/conventions/brain-first.md` for the 5-step lookup protocol.
> **Convention:** See `references/conventions/quality.md` for citation and back-link rules.
...
broken brain. See `references/conventions/quality.md` for format.
