...
**Skill:** `references/publish/SKILL.md` tells the agent when to publish, defaults
...
- `references/ingest/SKILL.md` -- uses `gbrain files upload-raw` for raw sources
- `references/maintain/SKILL.md` -- uses `gbrain check-backlinks`, `gbrain lint`, `gbrain report`
- `references/publish/SKILL.md` -- NEW skill for `gbrain publish`
- `references/enrich/SKILL.md` -- references `gbrain files upload-raw` for raw API data
- `references/_brain-filing-rules.md` -- documents `.redirect.yaml` format and commands
