...
### Brain Filing Rules (`references/_brain-filing-rules.md`)
...
```bash
ls references/_brain-filing-rules.md && echo "Filing rules: OK"
grep -q '"version": "0.8.1"' references/manifest.json && echo "Manifest: OK"
```

Files that should be updated:
- `references/_brain-filing-rules.md` (new)
- `references/enrich/SKILL.md` (rewritten)
- `references/ingest/SKILL.md` (expanded)
- `references/maintain/SKILL.md` (expanded)
- `references/query/SKILL.md` (updated)
- `references/briefing/SKILL.md` (updated)
...
(people/, companies/, concepts/, civic/). See `references/_brain-filing-rules.md`.
