...
"we'll add tests later." See `references/skillify/SKILL.md` for the meta.

## `type: agents-md-dispatcher-needs-host-review`

Gbrain injects a marker into each AGENTS.md pointing to
`references/conventions/subagent-routing.md`. But if your dispatcher has
...
Read `references/conventions/subagent-routing.md`. Walk your dispatcher's
