...
`src/core/check-resolvable.ts` v0.31.7): `references/RESOLVER.md` and a sibling
...
EDITED=/path/to/your/AGENTS.md       # or references/RESOLVER.md, whichever you edited
...
explicit approval before staging. Same convention as `references/book-mirror/SKILL.md`.
