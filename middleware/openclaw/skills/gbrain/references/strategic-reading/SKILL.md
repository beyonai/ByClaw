...
Phase 5: Write and deliver
  ...
  └── Optional: render to PDF via references/brain-pdf.
```
...
- `references/book-mirror/SKILL.md` — book personalized to whole life (vs
  problem)
- `references/perplexity-research/SKILL.md` — current-intel cross-reference
  for fresh data
- `references/conventions/quality.md` — citation + back-link rules
