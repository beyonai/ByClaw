...
> **Filing rule:** Read `references/_brain-filing-rules.md` before creating any new page.
...
> **Convention:** See `references/conventions/quality.md` for Iron Law back-linking.
...
> **Router note:** This skill is a router. For specialized ingestion, see: idea-ingest, media-ingest, meeting-ingestion, req-bug-ingest.
...
2. **For each entity detected:**
   ...
   - **If no:** assess notability (see `references/_brain-filing-rules.md`). If the entity
...
- See `references/_brain-filing-rules.md` for the full notability gate
