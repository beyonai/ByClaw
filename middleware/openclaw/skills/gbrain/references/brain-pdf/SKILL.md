...
```
$HOME/.claude/references/gstack/make-pdf/dist/pdf
```
...
```bash
P="$HOME/.claude/references/gstack/make-pdf/dist/pdf"
...
- `references/book-mirror/SKILL.md` — produces a brain page that's a
  natural input to brain-pdf (chapter-by-chapter personalized analysis).
- `references/strategic-reading/SKILL.md` — same shape, problem-lens variant.
- `references/publish/SKILL.md` — share brain pages as password-protected
