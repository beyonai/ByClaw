...
> **Convention:** See `references/conventions/test-before-bulk.md` — test every cron job on 3-5 items first.
...
- Thin job prompts: jobs say "Read references/X/SKILL.md and run it" (no inline 3000-word prompts)
