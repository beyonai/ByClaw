...
- **Filing one specific page** → `references/brain-taxonomist/SKILL.md`. Brain-
...
- **Schema-check as part of EIIRP iteration** → `references/eiirp/SKILL.md`
...
- **Querying who knows about X** → `references/expert-routing/SKILL.md` (or
...
- **Don't add a type for a directory you imported once for triage.** Pack types are permanent decisions; one-time imports are not. See `references/conventions/schema-evolution.md` for the <20-pages-don't-pack-codify heuristic.
