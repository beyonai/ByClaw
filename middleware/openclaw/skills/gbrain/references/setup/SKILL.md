...
`references/migrations/v0.11.0.md` + `docs/guides/plugin-handlers.md` to
...
`references/gbrain-upgrade/SKILL.md` and follow it. It honors `self_upgrade.mode`:
...
→ **Load and execute `references/cold-start/SKILL.md`** immediately. Do not
