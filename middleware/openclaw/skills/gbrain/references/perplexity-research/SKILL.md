...
| Structured data lookup against a tracker | `references/data-research/SKILL.md` |
...
Called by `references/enrich/SKILL.md` when an entity page (person, company)
...
- `references/academic-verify/SKILL.md` — wraps perplexity-research for
  citation-verified academic claim checking
- `references/enrich/SKILL.md` — calls perplexity-research as part of the
  entity-enrichment loop
- `references/data-research/SKILL.md` — structured-data trackers (different
