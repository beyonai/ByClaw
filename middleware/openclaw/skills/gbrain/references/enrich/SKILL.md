...
> **Convention:** see `references/conventions/quality.md` for citation formats and source precedence.
...
1. Check notability gate (see `references/_brain-filing-rules.md`)
