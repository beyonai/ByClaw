...
- `references/signal-detector/SKILL.md` — creates raw concept stubs from text channels
- `references/voice-note-ingest/SKILL.md` — same for audio channels
- `references/idea-ingest/SKILL.md` — same for links / articles
