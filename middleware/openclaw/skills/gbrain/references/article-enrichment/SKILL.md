...
- `references/media-ingest/SKILL.md` — creates the raw article pages this skill enriches
- `references/idea-ingest/SKILL.md` — link/article ingestion with author people-page enforcement
