...
- `references/voice-note-ingest/SKILL.md` — same exact-phrasing pattern for
  audio capture
- `references/idea-ingest/SKILL.md` — single-link-or-article ingest with
  the same primary-subject filing rule
- `references/conventions/quality.md` — citations, back-links, voice
